...
CC=g++
OBJ=src/ParseCommandLine.o src/common_utils.o RNA_class/RNA.o RNA_class/thermodynamics.o src/DynProgArray.o src/extended_double.o src/forceclass.o src/pfunction.o src/rna_library.o src/structure.o src/TProgressDialog.o
