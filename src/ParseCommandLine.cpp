...
void ParseCommandLine::usage() {
    ...
    //cout << "All flags are case-insensitive, "
	...
	if( numOptionsNoParams >= 1 ) {
		//cout << "=========================================" << endl;
		cout << "==== Option Flags Without Parameters ====" << endl;
		//cout << "=========================================" << endl;
	...
	if( numOptionsWithParams >= 1 ) {
		//cout << "======================================" << endl;
		cout << "==== Option Flags With Parameters ====" << endl;
		//cout << "======================================" << endl;
		//cout << "All parameters must follow their associated flag directly."
			 //<< endl
